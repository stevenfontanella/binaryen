...
Expression* TranslateToFuzzReader::makeConst(Type type, bool isGlobalInitializer) {
  if (type.isRef()) {
  ...
  } else if (type == Types::getI64Pair() && oneIn(2) && !isGlobalInitializer && wasm.features.hasWideArithmetic()) {
